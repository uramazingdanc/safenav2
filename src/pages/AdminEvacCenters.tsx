...
import { Building2, MapPin, Phone, Search, Filter, Plus, Loader2, Radio, Edit, Trash2 } from "lucide-react";
...
const AdminEvacCenters = () => {
  ...
  const totalOccupancy = centers?.reduce((sum, c) => sum + (c.current_occupancy || 0), 0) || 0;
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 pb-20 md:pb-6 animate-fade-in bg-command min-h-screen">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="h-2 bg-slate-700 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all ${getCapacityColor(occupancy, capacity)}`}
      ...
      <EvacCenterModal open={isModalOpen} onClose={handleModalClose} editCenter={editCenter} />
    </div>
  );
};
